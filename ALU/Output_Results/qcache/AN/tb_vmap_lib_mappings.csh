...
cp -f /homes/user/stud/fall23/yl5334/tutorials_6863/ALU/Output_Results/qcache/AN/modelsim.ini .

# $vlib_exec /homes/user/stud/fall23/yl5334/tutorials_6863/ALU/./work
if($status == 0) then
  $vmap_exec -modelsimini modelsim.ini work /homes/user/stud/fall23/yl5334/tutorials_6863/ALU/./work
else
  echo "** Error: Library mapping failed. (Command: 'vlib /homes/user/stud/fall23/yl5334/tutorials_6863/ALU/./work')"
endif
...
# endif
# $vlib_exec /homes/user/stud/fall23/yl5334/tutorials_6863/ALU/.//Output_Results/qcache/AN/zin_vopt_work
if($status == 0) then
  $vmap_exec -modelsimini modelsim.ini z0in_work_ctrl /homes/user/stud/fall23/yl5334/tutorials_6863/ALU/.//Output_Results/qcache/AN/zin_vopt_work
else
  echo "** Error: Library mapping failed. (Command: 'vlib /homes/user/stud/fall23/yl5334/tutorials_6863/ALU/.//Output_Results/qcache/AN/zin_vopt_work')"
endif
